...
//        DDLog.i("progress progress:" + progress + ",all:" + all);
        ...
        if (progress >= all - 10) {
            tv.setText(refresh ? R.string.str_pull_loose_refreshing : R.string.str_pull_loose_load_more);
        } else {
            tv.setText(refresh ? R.string.str_pull_down_refresh : R.string.str_pull_up_loading);
        }
    }
