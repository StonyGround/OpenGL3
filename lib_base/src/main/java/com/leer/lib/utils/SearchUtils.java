...
public class SearchUtils<T> {
    ...
    private List<T> mSearchObjs = new ArrayList<>();
    private int[] mIndexes;

    public SearchUtils(List<T> objects, String... fields) throws Exception {
        super();
        init(objects, fields);
    }
     ...
     * 通过反射从对象中取出指定字段的值
     */
    private String getSearchKey(T info, String... fields) throws Exception {
