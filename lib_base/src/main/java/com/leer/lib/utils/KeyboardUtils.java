...
//        window.setSoftInputMode(softInputMode & ~WindowManager.LayoutParams
//        .SOFT_INPUT_ADJUST_RESIZE);
    ...
    public static void showSoftInputDelay(View view, long delay) {
        new Handler().postDelayed(() -> showSoftInput(view, InputMethodManager.SHOW_FORCED), delay);
    }
