...
public final class ToastUtils {
    ...
    public static View showCustomShort(int iconResId, String tip) {
        final View view = getView(R.layout.toast_tip);
        ((ImageView) view.findViewById(R.id.iv_toast_tip)).setImageResource(iconResId);
        ((TextView) (view.findViewById(R.id.tv_toast_text))).setText(tip);
        show(view, Toast.LENGTH_SHORT);
        return view;
    }
